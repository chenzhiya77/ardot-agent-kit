...
- Returns candidates per domain (style, color, typography, layout, scene, composition)
...
styleKeywords is required; the optional keyword params (colorKeywords / typographyKeywords / layoutKeywords / sceneKeywords / compositionKeywords) fall back to styleKeywords when omitted. Pass domain (style/color/typography/layout/scene/composition) to limit the search to a single domain.
